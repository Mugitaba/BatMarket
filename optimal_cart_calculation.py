...
def rank_stores(list_of_items, search_by_code):
    shopping_carts = find_cheapest_prices(list_of_items, search_by_code)
    ...
    return clean_sorted_shopping_carts


def get_optimal_cart(list_of_items, search_by_code):
    sorted_shopping_carts = rank_stores(list_of_items, search_by_code)
    ...
    for item in sorted_shopping_carts:
        ...
        for code in item[1]['cheapestProducts']:
            total_sum += item[1]['allProductsList'][code]['productPrice']
